 ...
 * Example usage:
 * ```
 *     return res.modelError();
 *     // -or-
 *     return res.modelError(optionalData);
 * ```
 *
 * Or with actions2:
 * ```
...
module.exports = function modelError(optionalData) {
  ...
  if (optionalData === undefined) {
    sails.log.info('Ran custom response: res.modelError()');
  ...
  // except in production use res.sendStatus().
    ...
    sails.log.info('Custom response `res.modelError()` called with an Error:', optionalData);
